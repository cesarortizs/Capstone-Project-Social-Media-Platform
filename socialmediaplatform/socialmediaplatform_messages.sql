...
INSERT INTO `messages` VALUES (1,5,2,'Hello','2025-05-01',1),(2,1,3,'What are you doing tonight?','2025-05-01',1),(3,4,1,'Lunch tomorrow?','2025-05-02',1),(4,3,2,'Good morning','2025-05-03',0),(5,1,4,'Check this out','2025-05-03',1),(6,2,3,'Hello','2025-05-06',0);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`usuariocurso`@`localhost`*/ /*!50003 TRIGGER `ins_sum` AFTER INSERT ON `messages` FOR EACH ROW INSERT INTO notifications 
